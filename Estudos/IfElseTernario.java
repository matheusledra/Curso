...
public class IfElseTernario {
	...
	public static void main(String[] args) {
		...
		if(iNota1 < 0 || iNota2 < 0 || iNota3 < 0 || iNota4 < 0) {
			...
			sNotaMaior = iNota1 < 0 ? "Nota 1 -> " + iNota1 : iNota2 < 0 ? "Nota 2 -> " + iNota2 : iNota3 < 0 ? "Nota 3 -> " + iNota3 : "Nota 4 -> " + iNota4;
			...
			sNotaMenor = iNota1 > 10 ? "Nota 1 -> " + iNota1 : iNota2 > 10 ? "Nota 2 -> " + iNota2 : iNota3 > 10 ? "Nota 3 -> " + iNota3 : "Nota 4 -> " + iNota4;
