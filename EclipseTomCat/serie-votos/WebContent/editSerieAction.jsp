...
<head>
<meta charset="UTF-8">
<title>Editando <c:out value="${ serie.nome }"/></title>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-quantum">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item active"><a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Editando: <c:out value="${ serie.nome }"></c:out></a></li>
				</ul>
			</div>
		</nav>
		...
		<div class="jumbotron">
			<form action="serie?action=verSerie&id=${ serie.getID() }" method="post">
				<div class="form-group">
					<label for="nome">Nome da Série: </label>
					<input type="text" name="nome" class="form-control" placeholder="Insira o nome da Série" value="${ serie.nome }"> 
				</div>
				<div class="from-group">
					<input type="hidden" id="acao" name="acao" value="editSerie">
