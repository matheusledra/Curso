...
<nav class="navbar navbar-expand-lg navbar-dark bg-quantum">
    <a class="navbar-brand border-nav-title" href="#"> Study</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="#">Lista Pessoas <span class="sr-only">(current)</span></a>
            </li>
        </ul>
...
<main>
	<div class="fundo-tabela">
		...
		<br/>
		<button class="btnCadPessoa" onclick="window.location.href = 'http://pt.stackoverflow.com'">Nova Pessoa</button>
	</div>
</main>
